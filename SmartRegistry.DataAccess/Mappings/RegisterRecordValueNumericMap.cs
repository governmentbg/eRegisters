...
{
    public class RegisterRecordValueNumericMap : ClassMap<RegisterRecordValueNumeric>
    {
        public RegisterRecordValueNumericMap()
        {
            Table("REGISTER_RECORD_VALUES_NUMERIC");
